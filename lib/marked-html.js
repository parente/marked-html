...
marked.setOptions({
    langPrefix: 'hljs lang-',  // see https://github.com/chjj/marked/issues/393
...
exports.get_argv = function() {
    return optimist
        ...
        .default('css_hljs_theme', 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.12.0/styles/xcode.min.css')
